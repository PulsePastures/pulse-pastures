...
export default function BattleArena() {
  ...
  // Simulation for the vision - in reality, this would be a WebSocket listener for Base events
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur-xl">
        <div className="flex flex-col">
          ...
          <h2 className="text-2xl font-black text-white italic">BASE MAINNET ARENA</h2>
        </div>
