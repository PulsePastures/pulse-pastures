      ...
      <div className="bg-[#fefce8] border-b-2 border-[#4A2F1D] py-4 px-8 flex justify-between items-center text-[10px] uppercase font-bold sticky top-0 z-[100] shadow-2xl transition-all">
        ...
        <div className="flex gap-6 items-center">
            <div className="flex gap-4 mr-4 items-center border-r-2 border-[#4A2F1D]/10 pr-8">
                 <a href="/buyback" className="px-4 py-2 bg-amber-400 text-[#4A2F1D] hover:bg-amber-300 border-2 border-[#4A2F1D] transition-all shadow-[3px_3px_0_#4A2F1D] active:translate-y-1 active:shadow-none font-black tracking-widest text-[10px] flex items-center gap-1.5">💰 BUYBACK</a>
