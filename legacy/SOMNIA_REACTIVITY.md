...
Frontend'de `@base-chain/reactivity` üzerinden gerçek zamanlı bildirimler alınır.
...
Yüksek frekanslı oyun işlemleri (Harvest, Buy vb.) için her seferinde cüzdan onayı beklemek yerine `@base-chain/viem-session-account` entegrasyonu planlanmıştır. Bu sayede kesintisiz bir oyun deneyimi sunulur.
